...
BEAMER_DEFAULTS = {
    ...
    'documentoptions': 'c',#text is at the top of each slide rather than centered.  Changing to 'c' centers the text on each slide (vertically)
}
...
class LiteralInclude(Directive):
    ...
    def run(self):
        ...
        text = highlight_code (''.join(lines), lang)
        ...
        retnode.line = 1
        retnode['classes'].append ('code-block')
